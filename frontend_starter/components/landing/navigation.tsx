      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`inline-block w-2 h-2 rounded-full bg-[#e34948] transition-all duration-500`} aria-hidden="true" />
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>viGEMMAlya</span>
            <span className={`font-mono transition-all duration-500 ${isScrolled ? "text-[10px] mt-0.5 text-muted-foreground" : "text-xs mt-1 text-white/60"}`}>AML</span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            />
            <Link href="/pipeline" className={`transition-all duration-500 ${isScrolled ? "text-xs text-foreground/70 hover:text-foreground" : "text-sm text-white/70 hover:text-white"}`}>
              Live pipeline
            </Link>
            <Button
              size="sm"
              ...
              asChild
            >
              <Link href="/cases">Open dashboard</Link>
            </Button>
          </div>
